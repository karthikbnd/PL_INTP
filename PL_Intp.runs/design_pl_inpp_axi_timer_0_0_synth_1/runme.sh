...
HD_PWD='C:/Users/kab/Desktop/workspace/PL_INTP/PL_Intp.runs/design_pl_inpp_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_pl_inpp_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_pl_inpp_axi_timer_0_0.tcl
