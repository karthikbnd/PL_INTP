...
HD_PWD='C:/Users/kab/Desktop/workspace/PL_INTP/PL_Intp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_pl_inpp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_pl_inpp_wrapper.tcl -notrace
