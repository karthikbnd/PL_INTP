...
HD_PWD='C:/Users/kab/Desktop/workspace/PL_INTP/design_PL_Intp_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_PL_Intp_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_PL_Intp_auto_pc_0.tcl
