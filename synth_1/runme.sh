...
HD_PWD='C:/Users/kab/Desktop/workspace/PL_INTP/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_PL_Intp_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_PL_Intp_wrapper.tcl
