...
HD_PWD='C:/Users/kab/Desktop/workspace/PL_INTP/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log design_PL_Intp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_PL_Intp_wrapper.tcl -notrace
